    ...
    <div className="main">
      <Router>
        <Routes>
          ...
          <Route path="/budget" element={<div className="adj"><div className="t1"><Sidebar /></div><div className="t-cpm"><BudgetPage /></div> </div>} />
          <Route path="/transactions" element={<div className="adj"><div className="t1"><Sidebar /></div ><div className="t-cpm grid-c7-content-override"><DeliveryStatus /></div> </div>} />
